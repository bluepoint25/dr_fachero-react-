...
export default function Planes({ setPagina }) {
  return (
    <main className="planes">
      <h1>Planes diseñados para ti</h1>
      <p>
        Elige la solución que mejor se adapte al tamaño y las necesidades de tu
        consulta. Sin contratos ni costos ocultos.
      </p>
        ...
        <article className="plan-card" aria-labelledby="plan-estandar-title">
          <header className="plan-inicial">
            ...
            <p className="precio-estandar">
              Ideal para profesionales independientes que inician su
              digitalización.
            </p>
          </header>
      ...
      <section className="plan-cta">
        ...
        <div className="cta-content">
          ...
          <p>
            ...
            solución perfecta para tu clínica. Ofrecemos demostraciones
            gratuitas y podemos diseñar un plan personalizado para centros con
            necesidades específicas.
          </p>

          <button
            type="button"
            className="btn-plan btn-solid"

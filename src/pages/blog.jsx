...
function Blog() {
  return (
    <section className="blog">
      {/* ===== Header lila (full-bleed) ===== */}
      <section className="blog-header">
        <div className="container">
          <h1>Blog de Dr. Fachero</h1>
          <p>
            Bienvenido al blog de Dr. Fachero, donde compartimos las últimas
            novedades y consejos para optimizar la gestión de tu clínica.
          </p>
        </div>
      </section>

      {/* ===== Feed / Cuerpo (SIEMPRE en blanco, dentro del container) ===== */}
      <section className="blog-feed">
        <div className="container">
          ...
          <article className="full-blog-post">
            ...
            <img
              src={personasBlog}
              alt="Doctor mostrando una tablet a un paciente"
          ...
          <article className="full-blog-post">
            ...
            <h2>Dr. Fachero lanza nueva funcionalidad de Reportes Avanzados</h2>

            <img
              src={fichablog}
              alt="Gráficos y estadísticas del módulo de reportes"
              className="featured-image"
            />
            ...
            <div className="post-content">
              ...
              <ul>
                ...
                <li>Gestionar la facturación y cobranza con mayor eficiencia.</li>
